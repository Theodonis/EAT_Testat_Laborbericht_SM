...
\begin{figure}[H]
        \includegraphics[ %trim=0.5cm 1cm 0.5cm 1cm,
         width=0.8\textwidth]{631_Bild4_Ohmsch.pdf}
    \caption{Messung mit dem KO}
    \label{fig:abb1}
\end{figure}

\textcolor{red}{Der Polradwinkel stimmt nicht ganz wenn man die Berechnung mit der Querreaktanz usw. durchführt. Zusätzlich noch begründen wiso Querreaktanz relevant ist}
\newpage
...
\begin{figure}[H]
        \includegraphics[ %trim=0.5cm 1cm 0.5cm 1cm,
         width=0.8\textwidth]{631_Bild5_Kapazitiv.pdf}
    \caption{Messung mit dem KO}
    \label{fig:abb1}
\end{figure}

An der Messkurve ist zu erkennen, dass der Phasenstrom der Phasenspannung um ca. 90 \degree voreilt. Weiter ist die erhöhte Phasenspannung gegenüber der ohmschen Last von der vorangehenden Messung ersichtlich. \textcolor{red}{Legende falsch -> nicht effektivwerte}
...
Die Phasenspannung eilt dem Phasenstrom um 90 \degree voraus. Auch hier ist der Einfluss der Belastungsimpedanz auf die Amplitude der Phasenspannung gut erkennbar. Während sie bei kapazitiver Last zunimmt, sinkt sie bei einer induktiven Belastung. \textcolor{red}{Legende falsch -> nicht effektivwerte}
