...
\vspace{0.4cm}
\textbf{Verwendete Messwerkzeuge}: Multimeter, Oszilloskop, Amperezange
...
Im Kurzschlussfall($U_1$ = 0V) fällt die induzierte Spannung $U_p$ über der Statorwicklung $\Delta U$ ab. Abhängig vom Erregerstrom verändert sich die induzierte Spannung und somit auch der Phasenstrom $I_1$.
