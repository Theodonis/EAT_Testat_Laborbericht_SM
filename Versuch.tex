...
Bei diesem Versuch wirkt die Synchronmaschine als Generator im Inselbetrieb. Der Gleichstrommaschine dient als Antrieb.
\vspace{0.3cm}
\begin{figure}[h]
    \centering
    ...
    \label{fig:abb1}
\end{figure}
Bei konstantem  Erregerstrom und konstanter Drehzahl wird eine Phasenspannung $U_1$, ein Phasenstrom $I_1$ und der Polradwinkel $\beta$ bei verschiedenen Lasten gemessen. Zum einen werden die Daten für eine kapazitive, eine induktive und eine ohmsche Last jeweils mit $I_1eff = 3.8A$ gemessen
...
\includegraphics[width=\textwidth]{631_Bild3.pdf}
\subcaption{Ohmsche Last}
\label{fig:abb1}
\end{minipage}
\begin{minipage}[t]{0.32\textwidth}
\includegraphics[width=\textwidth]{631_Bild2.pdf}
\subcaption{Kapazitive Last}
    \label{fig:abb1}
\end{minipage}
\begin{minipage}[t]{0.32\textwidth}
\includegraphics[width=\textwidth]{631_Bild1.pdf}
\subcaption{Induktive Last}
    \label{fig:abb1}
\end{minipage}
