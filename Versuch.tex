...
Als erstes sollen die Gleichstrommaschine und die ASM in Betrieb genommen werden und für die folgenden Messungen eingestellt werden.
...
Da es sich um eine Schleifringläufer-ASM handelt, kann über den Rotorkreis ein Widerstand zugeschaltet werden. Dieser begrenzt den Anlaufstrom. Nach dem Hochfahren werden die Schleifringe kurzgeschlossen und die ASM kann als Kurzschlussläufer betrachtet werden.
...
\begin{minipage}[t]{0.3\textwidth}
\centering
\includegraphics[width=0.6\textwidth]{wirk_1}
\subcaption{}
\end{minipage}
\begin{minipage}[t]{0.3\textwidth}
\centering
\includegraphics[width=0.8\textwidth]{wirk_2}
\subcaption{}
\end{minipage}
\begin{minipage}[t]{0.3\textwidth}
\centering
\includegraphics[width=0.8\textwidth]{wirk_3}
\subcaption{}
\end{minipage}
\end{figure}
...
\begin{minipage}[t]{0.3\textwidth}
\centering
\includegraphics[width=0.7\textwidth]{blind_unter}
\subcaption{Untererregung (Q positiv)}
\end{minipage}
\begin{minipage}[t]{0.3\textwidth}
\centering
\includegraphics[width=0.5\textwidth]{blind_nenn}
\subcaption{Nennbetriebspunkt}
\end{minipage}
\begin{minipage}[t]{0.3\textwidth}
\centering
\includegraphics[width=0.5\textwidth]{blind_ueber}
\subcaption{Übererregung (Q negativ)}
\end{minipage}
\end{figure}
\newpage
...
An der Abbildung ist zu erkennen, dass der Phasenstrom bei Nennerregung minimal ist. Die Maschine ist in diesem Punkt weder unter-/ noch übererregt.


\begin{figure}[H]
    \centering
        \includegraphics[width=0.8\textwidth]{v_diagramm.pdf}
    \caption{V-Kurve}
\end{figure}
